...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_define_behavior).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.btn_define_behavior) {// 完全自定义Behavior。
            startActivity(new Intent(this, DefineBehaviorActivity.class));
        }
    }
}
